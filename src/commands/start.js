...
export const startCommand = async (ctx) => {
  ...
  await ctx.reply(`
    ❗❗❗<b>Важная информация</b>❗❗❗\n\nБот будет присылать вам видеосообщения и голосовые сообщения.\nЕсли у вас есть <b>Telegram premium</b> и включено ограничение на отправку голосовых сообщений, наш бот не сможет отправить вам некоторые сообщения.\nПожалуйста, отключите это ограничение у себя в настройках. \n\n<b>(Настройки -> Конфиденциальность -> Голосовые сообщения)</b>
  `,
    {
      parse_mode: "HTML"
    })
